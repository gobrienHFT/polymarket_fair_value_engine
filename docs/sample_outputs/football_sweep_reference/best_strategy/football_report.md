...
## Summary
- Run ID: `best_strategy`
- Fixtures: `4`
- Frame snapshots: `32`
- Priced market snapshots: `64`
- Quoteable market snapshots: `19`
- Positive-edge market snapshots: `27`
- Average raw next-mid change: `0.036667`
- Average directional next capture: `0.095556`
- Positive capture rate: `0.722222`
...
- `edge_bucket` `0.01-0.02`: n=10, avg_raw_next=0.02, avg_dir_next=0.152, hit_rate=1.0
...
- `market_type` `away_win`: n=4, avg_raw_next=0.14, avg_dir_next=0.09, hit_rate=0.5
...
- `market_type` `home_or_draw`: n=4, avg_raw_next=-0.1275, avg_dir_next=0.1225, hit_rate=0.75
- `market_type` `home_win`: n=4, avg_raw_next=0.105, avg_dir_next=0.12, hit_rate=1.0
- `match_phase` `inplay`: n=10, avg_raw_next=0.071111, avg_dir_next=0.133333, hit_rate=0.444444
